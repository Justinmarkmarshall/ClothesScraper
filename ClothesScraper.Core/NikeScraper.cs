...
namespace ClothesScraper.Core
{
    public class NikeScraper : INikeScraper
    {
        ...
        public async Task<List<Trainer>> GetSaleTrainersResponseFromNike(int size = 11)
        {
            ...
            //size 11 url
            string url = $"https://www.nike.com/gb/w/mens-sale-shoes-1m67gz3yaepznik1zy7ok?sort=newest";
            ...
            if (searchResults.Any())
            {
                ...
                var garms = trainers.Map(size: size);
                ...
                //}
                #endregion SizeChecker
                //var garms = trainers.Map(stockCheck);

                await _efWrapper.SaveUniqueToDB(garms);
